Por hacer:
  ...
  18. tabla con correlaciones por estado, por municipio para secciones electorales, con elecciones 
  competidas y  elecciones no competidas
  19. Tabla triple con cambio en el voto, participación electoral y voto efectivo (dividido en partidos)