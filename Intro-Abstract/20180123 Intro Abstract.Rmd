...
Las elecciones en el Estado de México se identifican por la pérdida de voto por parte del PRI. En la gráfica se muestra el porcentaje de pérdida de votación efectiva generalizada, pero desigual. La gráfica muestra, en orden alfabético, los 125 municipios del Estado de México, el ancho de la barra es el volumen de votación efectiva. La altura es la diferencia entre el porcentaje de voto obtenido en la elección presidencial 2012, una elección muy favorable al PRI, contra el porcentaje de la votación efectiva obtenida en la votación para gobernador 2017. 
