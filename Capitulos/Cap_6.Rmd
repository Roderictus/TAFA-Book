...
Municipios@data #CVE_ENT




Municipios_Map <- fortify(Municipios, region = "nombre")
Municipios_Map[Municipios_Map$id == "CA?ADA MORELOS",]$id <- "CAÑADA MORELOS"
Municipios_Map[Municipios_Map$id == "SAN ANTONIO CA?ADA",]$id <- "SAN ANTONIO CAÑADA"
PueMun2016$id<-PueMun2016$MUNICIPIO #Para unirlos por nombre de municipio 
Municipios_Map <- left_join(Municipios_Map, PueMun2016, by = "id")
#head(Municipios_Map)
#Municipios_Map[is.na(Municipios_Map$Por_Voto),]#0 Na´s
no_classes <- 6
labels <- c()
